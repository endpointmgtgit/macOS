...
weburl="https://ccmdls.adobe.com/AdobeProducts/StandaloneBuilds/ACCC/ESD/6.3.0/207/osx10/ACCCx6_3_0_207.dmg"
appname="Adobe Creative Cloud"                                                          # The name of our App deployment script (also used for Octory monitor)
app="Adobe Creative Cloud.app"                                                          # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/Adobe Creative Cloud"              # The location of our logs and last updated data
processpath="/Applications/Utulities/Adobe Creative Cloud/ACC/CreativeCloud.app"        # The process name of the App we are installing
